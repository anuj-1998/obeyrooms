			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal"  method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">room image 4</label>
							<input type="file" name="room_img4" class="form-control" required="">
							
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label">room image 5</label>
							<input type="file" name="room_img5" class="form-control" required="">
...
$room_img4=$_FILES['room_img4']['name'];
$room_img5=$_FILES['room_img5']['name'];


$temp_name1=$_FILES['room_img1']['tmp_name'];
$temp_name2=$_FILES['room_img2']['tmp_name'];
$temp_name3=$_FILES['room_img3']['tmp_name'];
$temp_name4=$_FILES['room_img4']['tmp_name'];
$temp_name5=$_FILES['room_img5']['tmp_name'];
	# code...
...
move_uploaded_file($temp_name4, "room_images/$room_img4");
move_uploaded_file($temp_name5, "room_images/$room_img5");




$Insert_room="INSERT INTO rooms(r_cat_id,cat_id,date,room_title,room_img1,room_rent,room_img2,room_img3,room_img4,room_img5,room_desc,address)
values('$room_cat','$cat',NOW(),'$room_title','$room_img1','$room_rent','$room_img2','$room_img3','$room_img4','$room_img5','$room_desc','$room_address');";
